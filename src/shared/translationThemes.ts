...
export const TRANSLATION_THEMES: ThemeDef[] = [
  { id: 'default', en: 'Default', zh: '默认', css: 'border-left:3px solid #9C6B3C;color:#6B6155;' },
  { id: 'none', en: 'None', zh: '无', css: '' },
  { id: 'grey', en: 'Grey', zh: '灰色', css: 'color:#6b7280;border-left:3px solid #6b7280;' },
  { id: 'dashed', en: 'Dashed border', zh: '虚线边框', css: 'border:1px dashed #9C6B3C;color:#6B6155;' },
  { id: 'solidBorder', en: 'Solid border', zh: '实线边框', css: 'border:1px solid #9C6B3C;color:#6B6155;' },
  { id: 'dotted', en: 'Dotted border', zh: '点线边框', css: 'border:1px dotted #9C6B3C;color:#6B6155;' },
  { id: 'thinDashed', en: 'Thin dashed', zh: '细虚线', css: 'border-left:2px dashed #9C6B3C;color:#6B6155;' },
  { id: 'underline', en: 'Underline', zh: '下划线', css: 'text-decoration:underline;text-decoration-color:#9C6B3C;text-underline-offset:3px;color:#2B2620;' },
  { id: 'nativeUnderline', en: 'Native underline', zh: '原生下划线', css: 'text-decoration:underline;color:#2B2620;' },
  { id: 'nativeDashed', en: 'Native dashed', zh: '原生虚线', css: 'border-bottom:1px dashed currentColor;color:#2B2620;' },
  { id: 'nativeDotted', en: 'Native dotted', zh: '原生点线', css: 'border-bottom:1px dotted currentColor;color:#2B2620;' },
  { id: 'wavy', en: 'Wavy', zh: '波浪线', css: 'text-decoration:underline wavy #9C6B3C;text-underline-offset:3px;color:#2B2620;' },
  { id: 'highlight', en: 'Highlight', zh: '高亮', css: 'background:rgba(156,107,60,.14);color:#2B2620;border-radius:3px;padding:2px 4px;' },
  { id: 'marker', en: 'Marker', zh: '荧光笔', css: 'background:linear-gradient(transparent 55%, rgba(255,221,87,.55) 55%);color:#2B2620;' },
  { id: 'marker2', en: 'Marker 2', zh: '荧光笔 2', css: 'background:linear-gradient(transparent 40%, rgba(156,107,60,.28) 40%);color:#2B2620;' },
  { id: 'paper', en: 'Paper', zh: '纸张', css: 'background:#FBF7EE;color:#4A4036;border-left:3px solid #9C6B3C;padding:4px 8px;border-radius:4px;' },
  { id: 'background', en: 'Background', zh: '底色', css: 'background:#F5EFE3;color:#4A4036;padding:2px 6px;border-radius:4px;' },
  { id: 'blockquote', en: 'Blockquote', zh: '引用块', css: 'border-left:4px solid #9C6B3C;padding-left:12px;color:#6B6155;font-style:italic;' },
  { id: 'dividingLine', en: 'Dividing line', zh: '分割线', css: 'border-top:1px solid #E8DECC;padding-top:6px;color:#6B6155;' },
  { id: 'weakening', en: 'Weakening', zh: '弱化', css: 'opacity:.72;color:#6b7280;' },
  { id: 'opacity', en: 'Opacity', zh: '透明度', css: 'opacity:.85;color:#6B6155;' },
  { id: 'italic', en: 'Italic', zh: '斜体', css: 'font-style:italic;color:#6B6155;' },
  { id: 'bold', en: 'Bold', zh: '粗体', css: 'font-weight:600;color:#2B2620;' },
  { id: 'mask', en: 'Mask', zh: '遮罩', css: 'background:rgba(43,38,32,.06);color:#4A4036;padding:2px 4px;border-radius:3px;' },
  { id: 'readingFocus', en: 'Reading focus', zh: '专注阅读', css: 'border-left:3px solid #9C6B3C;color:#2B2620;font-weight:500;background:rgba(156,107,60,.06);padding:4px 8px;border-radius:4px;' },
]
